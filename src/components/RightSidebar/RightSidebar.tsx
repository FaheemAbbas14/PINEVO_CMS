...
const FIELD_CONFIG = {
  ...
  text_input: [
    ...
    { key: 'maxLengthSubmitScreen', label: 'Submit Screen', type: 'screenSelect', dependsOn: { key: 'maxLengthAction', value: 'submit' } },
  ...
  button: [
    ...
    { key: 'goToScreen', label: 'Go to Screen', type: 'screenSelect', dependsOn: { key: 'function', value: 'goto_screen' } },
    { key: 'submitGoToScreen', label: 'Submit Screen', type: 'screenSelect', dependsOn: { key: 'function', value: 'submit' } },
